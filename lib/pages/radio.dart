  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => {Get.back(), widget.closeRadio()},
        ...
        () => Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Colors.black, radioController.getMainColor()],
              ),
            ),
            child: SafeArea(
              child: Stack(
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: Material(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: radioController.imageUrl(),
                  ...
                  Positioned(
                      ...
                      left: 10,
                      right: 10,
                      child: radioController.loading.isTrue
                          ? Center(
                          ...
                          : Column(
                              children: [
                                Text(
                                  radioController.songs[
                                      radioController.selectedKey.value]!,
                                ...
                                Row(
                                  ...
                                  children: [
                                    !radioController.controller.value.isPlaying
                                        ? IconButton(
                                            icon: const Icon(

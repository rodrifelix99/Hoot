...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  void onShake() {
    FirebaseCrashlytics.instance.log("Shakezão");
  }
                    ...
                    child: PageTransitionSwitcher(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Obx(() => _radioController.closeRadio.isFalse
                              ? Positioned(
                                  bottom: 10,
                                  left: 20,
                                  right: 20,
                                  child: OpenContainer(
                                    ...
                                    openBuilder: (context, close) =>
                                        RadioPage(closeRadio: _closeRadio),
                                  ),
                                )
                              : const Positioned(
                                  bottom: 0, child: SizedBox.shrink())),
                        ],
                      ),
                    ),
                  ),
                    ...
                    icon: Stack(
                      children: [
                        _pageController.hasClients &&
                            ...
                            ? const Icon(SolarIconsBold.bell)
                            : const Icon(SolarIconsOutline.bell),
                        Positioned(
                            top: 0,
                            right: 0,
                            child: _authProvider.notificationsCount > 0
                                ? Container(
                                    ...
                                    child: Text(
                                      _authProvider.notificationsCount
                                          .toString(),

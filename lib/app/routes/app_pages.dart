...
class AppPages {
  static final pages = [
    ...
    GetPage(name: AppRoutes.searchByGenre, page: () => SearchByGenrePage(type: FeedType.general)),
    ...
    GetPage(name: AppRoutes.post, page: () => PostPage()),
    GetPage(name: AppRoutes.report, page: () => ReportPage(user: U(uid: ''))),

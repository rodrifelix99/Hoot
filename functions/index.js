...
//every 24 hours send a push notification to users who have not opened the app in 48 hours (lastOnline < 48 hours ago)
exports.notifyUpInactiveUsers = functions.region("europe-west1").pubsub.schedule("every 24 hours").onRun(async (context) => {
  try {
